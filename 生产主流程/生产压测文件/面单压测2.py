...
class Test(TaskSet):
    ...
    def create_order(self):#下单
        ...
        with self.client.get('/group1/M00/0B/70/rB8Svmc7CN6AEucnAACyLjBDVlY349.pdf', name = "测试",headers = headers, catch_response = True) as response:
