...
from FOMS生产主流程.TWMS.Asn_Confirm import select_asn_id, asn_confirm
from FOMS生产主流程.TWMS.Asn_receive import asn_receive
from FOMS生产主流程.TWMS.Box_By_Order import box_by_order
from FOMS生产主流程.TWMS.Close_Box import close_box
from FOMS生产主流程.TWMS.Order_Handover import order_handover
from FOMS生产主流程.TWMS.Pick_Wave import select_centre_id_OR_client_ids, create_pick_wave
from FOMS生产主流程.TWMS.Pick_add_order import pick_add_order
from FOMS生产主流程.TWMS.TWMS_Login import Twms_CN_login
from FOMS生产主流程.properties.GetProperties import getProperties
from FOMS生产主流程.public.cancel_Order import Cancel_Order
from FOMS生产主流程.public.cancel_asn import cancel_asn
from FOMS生产主流程.public.create_ASN import create_ASN
from FOMS生产主流程.public.create_Order import create_Order
from FOMS生产主流程.public.create_SKU import create_SKU
from FOMS生产主流程.public.foms_login import foms_login
...
class MyTestCase(unittest.TestCase):
    ...
    def foms_test_case_order(self):
        ...
        # sku_number = "BACK_SKU202406032358532"
        ...
        # asn_number = "BACKASN202405207169162"
        time.sleep(10)
        ...
        order_number = create_Order(sku_number,properties,foms_token)
        # order_number = "BACK_OR202406013941659"
        time_end = time.time()
